...
const baseClassName =
  'transition-colors duration-300 w-full cursor-pointer rounded-lg py-2 text-sm font-medium leading-5 ring-white focus:outline-none ring-offset-2 focus:ring-2 ring-opacity-60'
...
function FilterTabs(props: Props) {
  ...
  return (
    <div className="sticky px-4 py-2 top-0 z-10">
