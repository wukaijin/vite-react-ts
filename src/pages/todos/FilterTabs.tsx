 ...
 * @LastEditTime: 2023-01-01 02:37:54
...
const baseClassName =
  'w-full cursor-pointer rounded-lg py-2.5 text-sm font-medium leading-5 ring-white focus:outline-none ring-offset-2 focus:ring-2 ring-opacity-60'
const btnClassName =
...
const FilterTabs = (props: Props) => {
  ...
  return (
    <div className="sticky mt-3 pt-2 top-0 z-10">
