 ...
 * @FilePath: /vite-react-ts/src/pages/blog/blog-hero/index.tsx
 * @Description:
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        >
          <div
            className={clsx('w-full sm:max-w-240 m-auto ', {
              'pt-16': !isMobile
            })}
          >
            <div className="grid grid-cols-1 sm:grid-cols-2">
              <div className="text-right">
                <div className="pr-12">
                  ...
                  >
                    <div className="mt-6 mb-2 mr-8">
                      <img
                        className="h-25 aspect-square rounded-[30%] bg-gray-100"
                        style={{
                ...
                <animated.div className="text-left text-xl px-4" style={{ ...textStyles }}>
                  ...
                  <p>
                    This blog documents my personal experiences in learning programming, with
                    articles written in Markdown. It is more of a collection of notes and snippets
                    rather than formal tutorials.
                  </p>
      ...
      <animated.div
        className={clsx('container sm:min-w-150 lg:max-w-300 m-auto')}
        style={{
          ...resentStyles
        }}
      >
