...
const opacityStyle: CSSProperties = { opacity: 0.6 }
const NoData = (props: Props) => {
  const { className, ...resProps } = props
  return (
    <div className={clsx('inline-block m-auto', className)} {...resProps}>
      <svg width="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
        <g id="freepik--background-complete--inject-6">
          <rect y="382.4" width="500" height="0.25" fill="#ebebeb" />
          <rect x="416.78" y="398.49" width="33.12" height="0.25" fill="#ebebeb" />
          <rect x="322.53" y="401.21" width="8.69" height="0.25" fill="#ebebeb" />
          <rect x="396.59" y="389.21" width="19.19" height="0.25" fill="#ebebeb" />
          <rect x="52.46" y="390.89" width="43.19" height="0.25" fill="#ebebeb" />
          <rect x="104.56" y="390.89" width="6.33" height="0.25" fill="#ebebeb" />
          <rect x="131.47" y="395.11" width="93.68" height="0.25" fill="#ebebeb" />
          <path
          ...
          <polygon
            ...
            style={opacityStyle}
          />
          <rect x="378.8" y="316.78" width="28.89" height="5.7" fill="#e6e6e6" />
          <rect
            x="324.31"
            y="251.33"
            width="5.33"
          ...
          <rect
            ...
            fill="#f5f5f5"
          />
          <rect x="378.8" y="347.95" width="28.89" height="5.7" fill="#e6e6e6" />
          <rect
            x="305.84"
            y="347.95"
            width="72.96"
            ...
            fill="#f5f5f5"
          />
          <rect x="378.8" y="254.45" width="28.89" height="5.7" fill="#e6e6e6" />
          <rect
            x="305.84"
            y="254.45"
            width="72.96"
            ...
            fill="#f5f5f5"
          />
          <rect x="378.8" y="285.61" width="28.89" height="5.7" fill="#e6e6e6" />
          <rect
            x="305.84"
            y="285.61"
            width="72.96"
        ...
        <g id="freepik--window-no-data--inject-6">
          <rect
            x="103.78"
            y="202.37"
            width="1"
          ...
          <path
            ...
            fill="currentColor"
          />
          <polygon points="243.19 208.48 233.09 202.4 236.8 210.46 243.19 208.48" fill="#ebebeb" />
          <path
        ...
        <g id="freepik--Character--inject-6">
          ...
          <path
            ...
            fill="#263238"
          />
          <path d="M324.44,141.67l-1.66-.31S323.73,142.54,324.44,141.67Z" fill="#263238" />
          <polygon
          ...
          <polygon
            ...
            fill="#ffb573"
          />
          <path d="M378.35,134.44l.73-7L372.6,129s-.1,6.58,3.33,7.62Z" fill="#ffb573" />
          <polygon
